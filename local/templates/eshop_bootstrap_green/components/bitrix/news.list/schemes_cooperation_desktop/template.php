...
//		xprint($arItem["PROPERTIES"]);
		?>
		<div class="schemes-item desktop" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
			...
			<div class="schemes-description">
				...
				<? if (strlen($arItem["PROPERTIES"]['DESCR' . $arParams['LANG_SUFFICS']]['~VALUE']['TEXT'])): ?>
