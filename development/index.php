...
<head>
	<meta charset="UTF-8">
	<title>Web Development Agency FMF in Thailand</title>
	...
	<meta name="description" content="Web development services from FMF. Increase your brand's online presence with our exceptional web development services. You can get professional advice by filling out a form on our website or calling: (+66) 083-788-4484.">
...
<body>
	...
	<div class="first-block development">
		<div class="wrap_container">
			<div class="index-img">
				<div class="index-description">
					<h1>
						Web Development Agency in Thailand
					</h1>
					<div class="description">
						Since 1999 we have realized over a hundred projects of various difficulty levels: corporate websites and online shop to huge and multi-layered internet portals.
					</div>
				</div>
				<div class="item-index-img"><img src="/img/development-index.svg"></div>
			</div>
	...
	<?php
		$arBreadCrumbs = [
			[
				'name' => 'Web Development Agency in Thailand',
			]
		];
		include $_SERVER['DOCUMENT_ROOT'].'/include/breadcrumbs.php';
	?>
	
	<div class="description-block white-background">
		<div class="wrap_container">
			<h2>Stages of Approach to Work</h2>
			<div class="description-items">
				<div class="description-grey">
					<p>We specialize in crafting bespoke web solutions that resonate with your audience and stand the test of time. Our approach, combining analytical precision and practical innovation.</p>
				</div>
				<div class="description-bold">
					Each of our solutions is created with your foundational requirements in mind, ensuring safety, scalability, and optimization for enduring performance. Prices for our comprehensive services are tailored to the scope of your project, delivering value and precision for your investment in Thailand's digital landscape.
				</div>
			</div>
			<div class="block-image-desktop">
				<img src="/img/stages-of-approach-to-work.svg">
			</div>
			<div class="block-image-mobile">
				<img src="/img/stages-of-approach-to-work-small.svg">
			</div>
		</div>
	</div>
		...
		<div class="wrap_container">
			<div class="services-item no-border">
				<div class="services-logo">
					<div class="services-subtitle title-small">
						Our Services
					</div>
				</div>
				<div class="services-more-items">
					<div class="services-description">
						<p>
							Our seasoned expertise in web development encompasses a broad spectrum of services to meet the evolving needs of businesses in Thailand
						</p>
					</div>
				</div>
			</div>
			<a href="#feedback" rel="modal:open" class="services-item">
				<div class="services-logo">
					<img src="/img/business-automation.svg">
				</div>
				<div class="services-more-items">
					<div class="services-description">
						...
						<p>
							Business automation can help simplify and speed up many tasks such as project management, financial accounting, human resource management and more, as well as improve the efficiency of your operations, reduce staff labor and resources, and improve the quality of your services and products.
						</p>
						<p>
							Optimize your operations with our custom-built systems and enterprise portals to minimize effort and errors and streamline decision-making.
						</p>
					</div>
				</div>
			</a>
			<a href="#feedback" rel="modal:open" class="services-item">
				<div class="services-logo">
					<img src="/img/custom-web-design.svg">
				</div>
				<div class="services-more-items">
					<div class="services-description">
						<div class="services-title">
						...
						<p>
							In today's world, where competition in the marketplace is only increasing, it is important to have a unique and memorable website. Increase your brand awareness and drive sales with websites designed for maximum exposure and user engagement.
						</p>
					</div>
				</div>
			</a>
			<a href="#feedback" rel="modal:open" class="services-item">
				<div class="services-logo">
					<img src="/img/web-applications.svg">
				</div>
				<div class="services-more-items">
					<div class="services-description">
						<div class="services-title">
						...
						<p>
							From social networks to message boards, we develop applications that seamlessly integrate into your business infrastructure, creating a seamless digital platform.
						</p>
						<p>
							Creating web applications can be very beneficial for businesses as they can help automate many processes and improve customer experience. Web application integration can be especially useful for companies that have multiple departments or branches, as they can use web applications to share information and coordinate work.
						</p>
					</div>
				</div>
			</a>
			<a href="#feedback" rel="modal:open" class="services-item">
				<div class="services-logo">
					<img src="/img/thoughtful-user-experience.svg">
				</div>
				<div class="services-more-items">
					<div class="services-description">
						<div class="services-title">
						...
						<p>
							When developing user interfaces for web applications, we pay special attention to an in-depth analysis of user needs and expectations. We strive to create a unique visual experience that focuses on the functionality and efficiency of using the application.
						</p>
						<p>
							We use modern technologies and tools to create a high-quality product that will meet your needs and user expectations.
						</p>
					</div>
				</div>
			</a>
			<a href="#feedback" rel="modal:open" class="services-item">
				<div class="services-logo">
					<img src="/img/ongoing-technical-support.svg">
				</div>
				<div class="services-more-items">
					<div class="services-description">
						<div class="services-title">
						...
						<p>
							We provide ongoing support to our clients to help resolve any issues that may arise while using web projects.
						</p>
						<p>
							Our team of experts is ready to help you every step of the way in developing and maintaining your web application so you can focus on your business goals and success.
						</p>
					</div>
				</div>
			</a>
	...
	<div id="our-works" class="wrap_container our-works-block development">
		<div class="block-title">
			<h2>Our Works</h2>
			<a href="/our-work/" class="purple-dark our-works-desktop-link">See all</a>
		</div>
		<div class="our-works-container">
			<div class="our-works-big-item our-works-item our-works-item-first">
				<div class="our-works-item-img" style="background: url(/img/kia-motors.png); background-size: cover; background-repeat: no-repeat; background-position: center;"></div>
				...
				<div class="item-bottom">
					<div class="description-only">
						Automatization of the vacation arranging process on the customer’s corporate portal.
					</div>
				</div>
			</div>
			
			<div class="our-works-big-item our-works-item our-works-item-second">
				<div class="our-works-item-img" style="background: url(/img/hyundai.png); background-size: cover; background-repeat: no-repeat; background-position: center;"></div>
				<h3 class="title">Hyundai</h3>
				<p class="subtitle">The largest automaker in South Korea and one of the largest in the world</p>
				<div class="item-bottom">
					<div class="description-only">
						Creating a web-service HPromise.hyundai.ru to provide users with a catalog of used Hyundai cars
					</div>
				</div>
			</div>
			
			<div class="our-works-big-item our-works-item our-works-item-third">
				<div class="our-works-item-img" style="background: url(/img/tetrapak.png); background-size: cover; background-repeat: no-repeat; background-position: center;"></div>
				<h3 class="title">TetraPak</h3>
				<p class="subtitle">Swedish-Swiss multinational company producing packaging, packaging machines and equipment for the processing of liquid food products</p>
				<div class="item-bottom">
					<div class="description-only">
						Providing the company with our product for automating vacation management
					</div>
				</div>
			</div>
		...
		<a href="/our-work/" class="purple-dark our-works-mobile-link">See all</a>
	</div>
	
	<div class="formats-block grey-background context-ad">
		<div class="wrap_container">
			<h2>Our Principles</h2>
			<div class="formats-container">
				<div class="formats-item-small item-no-bg">
					<p>At FMF, we specialize in crafting bespoke web solutions that resonate with your audience and stand the test of time. Our two-pronged approach, combining analytical precision and practical innovation.</p>
				</div>
				<div class="formats-item-small">
					<h3>Competitive Analysis</h3>
					<div class="description">
						<p>We start by scrutinizing the digital landscape, ensuring your website outperforms competitors on every front.</p>
					</div>
				</div>
				<div class="formats-item-small">
					<h3>Goal-Oriented Design</h3>
					<div class="description">
						<p>Understanding your mission and audience is key to creating a high-impact website that delivers results.</p>
					</div>
				</div>
				<div class="formats-item-small">
					<h3>Scalable & Secure Solutions</h3>
					<div class="description">
						<p>Our designs are future-proof, ready to grow with your business, and secure to protect sensitive data.</p>
					</div>
				</div>
				<div class="formats-item-small">
					<h3>SEO-Optimized Development</h3>
					<div class="description">
						<p>We craft sites primed for search engine success, driving visibility for your key queries.</p>
					</div>
				</div>
			</div>
		</div>
